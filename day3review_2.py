...
#    매개변수 : 없음, 리턴값 : 없음, 기능 : 파이썬 교재명을 화면에 출력
#    함수명 : print_book_publisher
#    매개변수 : 없음, 리턴값 : 없음, 기능 : 파이썬 교재의 출판사명을 화면에 출력
...
# get_book_title() 함수를 호출하고 리턴되는 결과를 name 변수에 저장한 다음 name 변수의 값을 2회 출력한다.
...
# 숫자 2개와 연산자 1개를 전달하여 expr() 이라는 함수를 호출한 다음 리턴 결과가 None 이면 수행 불가를 출력하고 그렇지 않으면 연산결과 : XX 를 출력한다.
def expr(n1,n2,c):
    if c == "+" or c == "-" or c == "*" or c == "/":
        if c == "+":
            cal= n1+n2
...
print("<<4번>>")
# 함수명 : print_triangle
# 매개변수 : 1개, 리턴값 : 없음, 기능 : 전달된 숫자 개수로 구성되는 삼각형을 출력
...
# 5번
print("<<5번>>")
# 함수명 : print_uptriangle
# 매개변수 : 1개, 리턴값 : 없음, 기능 : 전달된 숫자 개수로 구성되는 역삼각형을 출력
...
print("<<6번>>")
# 함수명 : print_gugudan
# 매개변수 : 1개, 리턴값 : 없음, 기능 : 전달된 숫자의 구구단을 출력한다.
